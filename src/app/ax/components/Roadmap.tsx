    ...
    return (
        <section id="roadmap" className="space-y-6">
            <div className="text-center max-w-2xl mx-auto space-y-2">
                <h3 className="text-2xl font-bold text-slate-900">단계별 보안 체계 트랜지션 로드맵</h3>
                <p className="text-slate-600 text-sm">레거시 업무 효율화를 통해 고도화된 AX 보안 체계를 안정화하기까지의 3단계 타임라인입니다.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 relative">
                {/* Step 1 Card */}
                <div className="bg-white border border-slate-200 rounded-2xl p-6 relative flex flex-col justify-between">
                    <div>
                        ...
                        <h4 className="text-base font-bold text-slate-900 mb-2">수동 레거시 보안 극단 효율화</h4>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-6 relative flex flex-col justify-between">
                    <div>
                        ...
                        <h4 className="text-base font-bold text-slate-900 mb-2">안전한 자율적 자정 보안 생태계</h4>
                        <p className="text-xs text-slate-600 leading-relaxed mb-4">
