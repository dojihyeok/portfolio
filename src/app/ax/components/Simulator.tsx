    ...
    return (
        <section id="simulator" className="space-y-6 relative">
            <div className="text-center max-w-2xl mx-auto space-y-2">
                <h3 className="text-2xl font-bold text-slate-900">AX 보안 챔피언 실무 시뮬레이터</h3>
                <p className="text-slate-600 text-sm">소속 부서를 선택하여 AX 보안 챔피언으로서 기여할 수 있는 실무 과제와 개인별 가치를 모의 체험해 보세요.</p>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 relative overflow-hidden">
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4 relative z-10">
                        <label className="block text-sm font-semibold text-slate-700">내 소속 부서 선택</label>
                    ...
                    <div className="md:col-span-2 bg-slate-50 rounded-2xl p-6 border border-slate-200 flex flex-col justify-between relative z-10">
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-700 mt-1">{data.challenge}</p>
                                    </div>
                                    <div>
                                        <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">챔피언의 보안 개선 솔루션 (R&R)</div>
                                        <p className="text-sm text-slate-700 mt-1">{data.solution}</p>
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {data.rewards.map((reward: string, idx: number) => (
                                                <span key={idx} className="text-xs bg-slate-100/80 border border-slate-300 text-slate-700 px-3 py-1.5 rounded-lg flex items-center space-x-1.5">
