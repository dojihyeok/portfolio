    ...
    return (
        <section id="paradigm" className="space-y-6">
            <div className="text-center max-w-2xl mx-auto space-y-2">
                <h3 className="text-2xl font-bold text-slate-900">보안 패러다임의 혁명적 대전환</h3>
                <p className="text-slate-600 text-sm">기존의 수동적 통제(Chokepoint) 모델에서 자율적 성장을 지원하는 조력자(Enabler) 모델로 도약합니다.</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
                {/* Legacy Security Card */}
                <div className="bg-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden group hover:border-slate-300 transition-all">
                    ...
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <h4 className="text-lg font-bold text-slate-800">Legacy Security (기존 레거시 보안)</h4>
                    </div>
                    <p className="text-slate-600 text-sm mb-6">규제 위주의 일률적인 접근 및 수동 처리 방식으로 인해 비즈니스의 병목지대 역할을 수행했습니다.</p>
                ...
                {/* AX Security Card */}
                <div className="bg-white border border-slate-300 rounded-2xl p-6 relative overflow-hidden group hover:border-indigo-500/50 transition-all shadow-lg shadow-indigo-500/5">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/10 rounded-full blur-2xl"></div>
                    <div className="flex items-center space-x-3 mb-4">
                        <div className="p-2 bg-indigo-500/20 text-indigo-400 rounded-lg">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                        </div>
                        <h4 className="text-lg font-bold text-slate-900">AX Security (신설 AX 보안)</h4>
                    </div>
                    <p className="text-slate-600 text-sm mb-6">AI 기반 가드레일 수립과 자동 대응 및 개선을 바탕으로, 비즈니스의 초고속 성장을 리드합니다.</p>
                    <ul className="space-y-3 text-sm text-slate-700">
                        <li className="flex items-start space-x-2">
