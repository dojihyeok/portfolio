        ...
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden w-full max-w-[100vw]">
            ...
            <section className="min-h-[70vh] flex flex-col justify-center items-center text-center px-4 py-20 relative overflow-hidden">
                ...
                >
                    ...
                    <p className="text-base md:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed px-4 break-keep font-medium mt-4 text-justify">
                        보안은 단순한 방어나 통제를 넘어 불확실성을 통제 가능한 리스크로 전환해 나가는 &apos;빌드업의 과정&apos;입니다. 우리는 AI를 활용해 소모적인 운영 업무를 자동화하고, 확보된 역량을 미래지향적인 아키텍처 설계에 집중합니다. 개선된 보안 지표를 실시간으로 확인하며 느끼는 즐거움으로 몰입하며 기업의 브랜드 신뢰를 완성합니다.
                    </p>
